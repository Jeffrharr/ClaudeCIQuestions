...
Before opening the conversation, read the diff carefully and prepare 2–3 **specific,
leading questions** grounded in what you actually see. Not generic — tied to specific
lines, functions, or patterns in this diff. Examples of the right shape:

- *"Line 34 removes the null check before calling `processUser()` — what's guaranteeing
  the value is present now?"*
